...
contract PrivateSale is Crowdsale, AllowanceCrowdsale, Ownable {
    using SafeMath for uint256;
    
    bool public onlyWhitelisted = true;
    address[] public whitelistAddresses = [0x5baA0f14D09864929c5fC8AbDfDc466dcb72be9d, 0xD109fc566401ca57445810b9A3C187876cf44544, 0x64DC48F2Ae171f7Ae966f15844eF2f8751665110];

    constructor(
        uint256 rate, // 2,000,000,000 if token decimals are nine
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        if(onlyWhitelisted) {
            require(isWhitelisted(msg.sender), "PRIVATE_SALE: user is not whitelisted");
        }
        require(beneficiary != address(0), "Crowdsale: beneficiary is the zero address");
        require(weiAmount != 0, "Crowdsale: weiAmount is 0");
